defmodule Aoc.Year2020.Day05.Seat do
  defstruct [:row, :seat, :score]
  alias __MODULE__

  def new(boarding_pass) do
    [[r, s]] = Regex.scan(~r/([F|B]{7})([R|L]{3})/, boarding_pass, capture: :all_but_first)
    ...
    %Seat{row: row, seat: seat, score: row * 8 + seat}
  end
end
  ...
  *What is the ID of your seat?*
  ...
  def part_2(input) do
    [[left, right]] =
      ...
      |> Enum.filter(fn [x, y] -> y.score - x.score == 2 end)
