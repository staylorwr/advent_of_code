defmodule Aoc.Year2018.Day07.TheSumofItsParts do
  @moduledoc """
  ...
  *In what order should the steps in your instructions be completed?*
  ...
  alias Aoc.Year2018.Day07.PartTwo

  defstruct [:steps, :reqs, :completed]

  defdelegate part_2(input, options), to: PartTwo
