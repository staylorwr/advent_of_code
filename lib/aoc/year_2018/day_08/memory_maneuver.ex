defmodule Aoc.Year2018.Day08.MemoryManeuver do
  ...
  *What is the sum of all metadata en
  ## --- Part Two ---
  ...
  *What is the value of the root node?*
  ...
  defp do_root_value(%{children_size: 0} = vertex) do
    vertex.metadata
    |> Tuple.to_list()
    |> Enum.sum()
    |> List.wrap()
  ...
  defp do_root_value(vertex) do
    Enum.flat_map(Tuple.to_list(vertex.metadata), fn index ->
      case Enum.at([nil | vertex.children], index) do
        nil -> []
